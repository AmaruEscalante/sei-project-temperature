...
HD_PWD='C:/Users/Alessio/Desktop/localGits/sei-project-temperature/proyectoVHDL/proyectoVHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_i2c_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_i2c_master.tcl
